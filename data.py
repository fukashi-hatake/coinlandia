...
def load_data(): 
    ...
    sheet3_url = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vRLTgxkwclFqHFN6qSfGfYhNgUyK4lyISq5nMyp43tLBl2ICiwbTnvPdfJyKypHe4K8fUhKLrzA7sSd/pubhtml?gid=1983727577&single=true'
    newDF = pd.read_csv(sheet1_url)
    oldDF = pd.read_csv(sheet2_url)
    short_listDF = pd.read_csv(sheet3_url)

    return newDF, oldDF, short_listDF
